...
Public standards, reusable shell components, and operator-style conventions for my local tools, helper applications, dotfiles, security workflows, and project ecosystems.

This repository exists to:

- show how I think and work
- keep projects visually and operationally consistent
- provide reusable shell components
- define script, documentation, commit, and directory-structure standards
